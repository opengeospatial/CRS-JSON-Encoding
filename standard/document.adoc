= JSON representation of coordinate reference systems
:doctype: standard
:encoding: utf-8
:lang: en
:status: draft
...
:fullname_2: Keith Ryden
:docsubtype: Interface
:keywords: ogcdoc, OGC document, coordinate reference systems, CRS, JSON
:submitting-organizations: ESRI; Geomatys
